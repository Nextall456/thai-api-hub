...
PLANS = [
    dict(code="trial", name_th="ทดลองใช้ฟรี", tier=0, price_month_thb=0, price_year_thb=0,
         ...
         features_th="โมเดลในเครื่อง (Local AI) + โมเดลฟรีจาก OpenRouter|30 คำขอ/วัน|300,000 tokens/เดือน|ใช้ฟรี 7 วันหลังสมัคร"),
    ...
    dict(code="pro", name_th="โปร", tier=2, price_month_thb=499, price_year_thb=4990,
         ...
         features_th="ทุกโมเดล + เลือกโมเดลใดก็ได้จาก OpenRouter|เส้นทางคุณภาพก่อน: Free → ประหยัด → Local|1,500 คำขอ/วัน|15 ล้าน tokens/เดือน|60 คำขอ/นาที|รองรับ alias โมเดลทั้ง 5 แบบ"),
